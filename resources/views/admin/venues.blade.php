...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-menu-item">
                <a href="{{ url('/admin/venues') }}" class="nav-menu-link active"><i class="fa-solid fa-hotel"></i> Kelola Gedung</a>
            </li>
            <li class="nav-menu-item">
            ...
            <div class="table-responsive">
                <table class="table custom-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <strong class="d-block text-white">{{ $venue->nama_ruangan }}</strong>
                                <small class="text-muted">{{ $venue->deskripsi }}</small>
                            </td>
                            <td><i class="fa-solid fa-users text-gray-500 me-1"></i> {{ $venue->kapasitas_tamu }}</td>
                            <td><i class="fa-solid fa-maximize text-gray-500 me-1"></i> {{ $venue->luas_area }} m²</td>
                            <td><strong>Rp {{ number_format($venue->harga_per_hari, 0, ',', '.') }}</strong></td>
                            <td>
                                <span class="status-badge badge-available">
                                    <i class="fa-solid fa-circle-check me-1"></i> {{ $venue->status_ketersediaan }}
                                </span>
                            </td>
                        </tr>
                        @empty
