...
<body class="bg-[#0b0b0b] text-white antialiased" x-data="{ isLogin: '{{ $mode }}' === 'login' }">
            ...
            <div class="card-form">
                ...
                <div x-show="isLogin" x-transition>
                    ...
                    <form action="{{ url('/login') }}" method="POST">
                        ...
                        <p class="text-center text-muted small mb-0">
                            Belum punya akun? <a href="{{ url('/register') }}" class="signup-link fw-semibold">Daftar sekarang</a>
                        </p>
                    </form>
                </div>
                ...
                <div x-show="!isLogin" x-transition style="display: none;">
                    ...
                    <form action="{{ url('/register') }}" method="POST">
                        ...
                        <p class="text-center text-muted small mb-0">
                            Sudah punya akun? <a href="{{ url('/login') }}" class="signup-link fw-semibold">Log In di sini</a>
                        </p>
                    </form>
                </div>
