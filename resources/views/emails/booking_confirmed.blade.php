        ...
        <div class="content">
            ...
            <table class="details-table">
                ...
                <tr>
                    ...
                    <td class="value">{{ $booking->tema_dekorasi }}</td>
                </tr>
                <tr>
                    <td class="label">Estimasi Tamu</td>
                    <td class="value">{{ $booking->estimasi_tamu }} Pax</td>
                </tr>
                <tr>
                    <td class="label">Total Estimasi Biaya</td>
                    <td class="value price-highlight">Rp {{ number_format($booking->total_estimasi, 0, ',', '.') }}</td>
                </tr>
                <tr>
                    <td class="label">Uang Muka (DP 30%)</td>
                    <td class="value price-highlight highlight">Rp {{ number_format($booking->total_estimasi * 0.3, 0, ',', '.') }}</td>
                </tr>
            </table>
            ...
            <div style="text-align: center; margin-top: 30px;">
                <a href="https://wa.me/6281234567890?text=Halo%20Admin%20Deandra,%20saya%20ingin%20mengonfirmasi%20pembayaran%20DP%20untuk%20booking%20%23BK-{{ str_pad($booking->id, 4, '0', STR_PAD_LEFT) }}" class="btn">Hubungi Kami &rarr;</a>
            </div>
        </div>
        <div class="footer">
