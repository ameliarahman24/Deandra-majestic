...
<main class="max-w-7xl mx-auto px-6 mt-8 mb-20">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
        ...
        <div class="bg-[#121214] border border-gray-800 rounded-2xl p-4 space-y-1">
            ...
            <a href="{{ url('/admin/dashboard') }}" class="flex items-center gap-3 {{ request()->is('admin/dashboard') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white' }} text-xs font-bold px-4 py-3 rounded-xl border border-gray-800 transition">
                <i class="fa-solid fa-chart-pie me-2"></i> Overview
            </a>
            <a href="{{ url('/admin/bookings') }}" class="flex items-center gap-3 {{ request()->is('admin/bookings') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white' }} text-xs font-medium px-4 py-3 rounded-xl transition">
