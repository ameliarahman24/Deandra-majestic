                    ...
                    @auth
                        @if(auth()->user()->role === 'user')
                            <template x-if="tanggalTerpilih !== null">
                                <a :href="'{{ url('/booking') }}?tanggal=' + currentDate.getFullYear() + '-' + String(currentDate.getMonth() + 1).padStart(2, '0') + '-' + String(tanggalTerpilih).padStart(2, '0')" 
...
<script>
    window.calendarBookings = @json($formattedBookings);
</script>
