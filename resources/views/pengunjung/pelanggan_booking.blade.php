...
<body>
        ...
        <div class="container-fluid px-md-4">
            ...
            <div class="collapse navbar-collapse justify-content-center">
                <ul class="navbar-nav gap-2">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ url('/booking') }}">Booking</a></li>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                @else
                    ...
                    <form action="{{ route('logout') }}" method="POST" id="logout-form-booking" class="d-none">
                        @csrf
                    </form>
    ...
    <div class="container main-container">
        <form action="{{ route('pengunjung.booking.store') }}" method="POST" id="form-booking">
            @csrf
                ...
                <div class="panel-box">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control form-control-custom" id="input-email" name="email" placeholder="nama@email.com" value="{{ auth()->check() ? auth()->user()->email : '' }}" required>
                        </div>
                        <div class="col-md-6">
