...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-menu-item">
                <a href="<?php echo e(url('/admin/notifications')); ?>" class="nav-menu-link active"><i class="fa-solid fa-bell"></i> Notifikasi</a>
            </li>
        ...
        <div class="mt-4">
            <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="notification-card">
                    <div class="notif-icon" style="background-color: <?php echo e($bgIcon); ?>; color: <?php echo e($colorIcon); ?>;">
                        <i class="<?php echo e($iconClass); ?>"></i>
                    </div>
                    <div class="notif-info">
                        <div class="notif-title"><?php echo e($title); ?></div>
                        <div class="notif-desc"><?php echo e($desc); ?></div>
                        <div class="notif-time"><i class="fa-solid fa-clock me-1"></i> <?php echo e(date('d/m/Y H:i', strtotime($notif->created_at))); ?></div>
                    </div>
                </div>
...
<?php /**PATH D:\semester 4\Deandra Majestic Final\buruan-nikah\resources\views/admin/notifications.blade.php ENDPATH**/ ?>