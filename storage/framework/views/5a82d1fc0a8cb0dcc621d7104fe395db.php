...
<body>
    ...
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container-fluid px-md-4">
            ...
            <div class="collapse navbar-collapse justify-content-center">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link active" href="<?php echo e(url('/home')); ?>">Home</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/booking')); ?>">Booking</a></li>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <?php else: ?>
                    ...
                    <form action="<?php echo e(route('logout')); ?>" method="POST" id="logout-form-home" class="d-none">
                        <?php echo csrf_field(); ?>
                    </form>
    ...
    <section class="hero-section">
        <div class="container d-flex flex-column align-items-center">
            ...
            <div class="d-flex justify-content-center">
                <a href="<?php echo e(url('/booking')); ?>" class="btn btn-hero-main">Book Sekarang &rarr;</a>
                <a href="<?php echo e(url('/jadwal')); ?>" class="btn btn-hero-sub">Lihat Jadwal</a>
            </div>
        </div>
    </section>
                    ...
                    <div class="venue-card">
                        ...
                        <div class="venue-body">
                            ...
                            <div class="venue-price-row">
                                ...
                                <a href="<?php echo e(url('/booking?venue=grand')); ?>" class="btn-select-venue">Pilih &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="venue-card">
                        ...
                        <div class="venue-body">
                            ...
                            <div class="venue-price-row">
                                ...
                                <a href="<?php echo e(url('/booking?venue=crystal')); ?>" class="btn-select-venue">Pilih &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="venue-card">
                        ...
                        <div class="venue-body">
                            ...
                            <div class="venue-price-row">
                                ...
                                <a href="<?php echo e(url('/booking?venue=garden')); ?>" class="btn-select-venue">Pilih &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <footer>
        <div class="container text-center">
            <p class="mb-0">&copy; <?php echo e(date('Y')); ?> Deandra Majestic Venue. All rights reserved.</p>
        </div>
    </footer>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="background-color: var(--card-dark); border: 1px solid rgba(223, 174, 98, 0.3); border-radius: 20px;">
                <div class="modal-body text-center p-5">
                    ...
                    <p class="text-gray-400 mb-4" style="font-size: 0.95rem;"><?php echo e(session('success')); ?></p>
...
</html><?php /**PATH D:\semester 4\Deandra Majestic Final\buruan-nikah\resources\views/pengunjung/home.blade.php ENDPATH**/ ?>