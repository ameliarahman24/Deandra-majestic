...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-menu-item">
                <a href="<?php echo e(url('/admin/bookings')); ?>" class="nav-menu-link active"><i class="fa-solid fa-calendar-check"></i> Data Booking</a>
            </li>
            <li class="nav-menu-item">
                <a href="<?php echo e(url('/admin/venues')); ?>" class="nav-menu-link"><i class="fa-solid fa-hotel"></i> Kelola Gedung</a>
            </li>
            <li class="nav-menu-item">
        ...
        <div class="row g-3">
            <div class="col-md-4">
                <div class="stat-card">
                    <div class="stat-info">
                        <h6>Total Masuk</h6>
                        <h3 id="stat-total"><?php echo e($totalBookings); ?> Reservasi</h3>
                    </div>
            ...
            <div class="col-md-4">
                <div class="stat-card">
                    <div class="stat-info">
                        ...
                        <h3 id="stat-pending" style="color: var(--status-pending);"><?php echo e($pendingBookings); ?> Pending</h3>
                    </div>
            ...
            <div class="col-md-4">
                <div class="stat-card">
                    <div class="stat-info">
                        ...
                        <h3>Rp <?php echo e(number_format($omzetDeal, 0, ',', '.')); ?></h3>
                    </div>
            ...
            <div class="table-responsive">
                <table class="table custom-table">
                    ...
                    <tbody>
                        ...
                        <tr id="booking-row-<?php echo e($booking->id); ?>">
                            <td>
                                <strong class="d-block"><?php echo e($booking->nama_mempelai_pria); ?> & <?php echo e($booking->nama_mempelai_wanita); ?></strong>
                                <div class="d-flex flex-column gap-1 mt-1">
                                    <small class="text-muted"><i class="fa-solid fa-phone me-1" style="color: #25d366;"></i> <?php echo e($booking->no_whatsapp); ?></small>
                                    <small class="text-muted"><i class="fa-solid fa-envelope me-1" style="color: var(--wedding-gold);"></i> <?php echo e($booking->email); ?></small>
                                </div>
                            </td>
                            <td>
                                <?php
                                ...
                                ?>
                                <span style="color: <?php echo e($venueColor); ?>; font-weight: 600;"><?php echo e($booking->nama_ruangan ?? 'Venue Lainnya'); ?></span>
                            </td>
                            <td>
                                <span><?php echo e(date('d M Y', strtotime($booking->tanggal_acara))); ?></span>
                                <small class="d-block text-muted">Sesi <?php echo e(ucfirst($booking->sesi)); ?></small>
                            </td>
                            <td><strong>Rp <?php echo e(number_format($booking->total_estimasi, 0, ',', '.')); ?></strong></td>
                            <td>
                            ...
                            <td class="text-center">
                                <?php if(strtolower($booking->status ?? 'pending') == 'pending' || empty($booking->status)): ?>
                                    <div class="d-flex justify-content-center gap-1">
                                        ...
                                        <form action="<?php echo e(route('admin.bookings.cancel', $booking->id)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\semester 4\Deandra Majestic Final\buruan-nikah\resources\views/admin/bookings.blade.php ENDPATH**/ ?>