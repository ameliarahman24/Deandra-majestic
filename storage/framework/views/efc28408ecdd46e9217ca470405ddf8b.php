...
<div class="min-h-screen bg-[#0b0b0c] text-gray-200 p-6 max-w-7xl mx-auto mt-8 mb-20">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
        ...
        <div>
            <a href="<?php echo e(url('/admin/dashboard')); ?>" class="inline-flex items-center justify-center px-4 py-2.5 bg-gray-800 hover:bg-gray-700 text-white font-semibold text-sm rounded-xl transition border border-gray-700">
    ...
    <div class="bg-[#121214] border border-gray-800/70 rounded-2xl p-8 max-w-2xl mx-auto text-center mt-10">
        <div class="mb-6 flex justify-center">
            <img src="<?php echo e(asset('postman_mailbox_empty.png')); ?>" class="w-64 h-64 object-contain" alt="Belum Ada Pesan">
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\semester 4\Deandra Majestic Final\buruan-nikah\resources\views/admin/chat.blade.php ENDPATH**/ ?>